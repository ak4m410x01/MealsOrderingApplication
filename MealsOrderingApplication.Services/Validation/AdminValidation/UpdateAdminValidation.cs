...
{
    public class UpdateAdminValidation : BaseAdminValidation, IUpdateAdminValidation
    {
        public UpdateAdminValidation(IUnitOfWork unitOfWork, UserManager<ApplicationUser> userManager) : base(unitOfWork, userManager)
        {
        }
